...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Bonni Bot ✍;;;\nFN:Bonni Bot ✍\nORG:Bonni Bot ✍\nTITLE:\nitem1.TEL;waid=51935763050:+51 935 763 050\nitem1.X-ABLabel:Bonni Bot ✍\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:Bonni Bot✍\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: 'Bonni Bot ✍', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'Bonni Bot' , thumbnail: imagen1, sourceUrl: 'https://instagram.com/comunidad.nm?igsh=MII1b204cmo4Y3o1OQ==' }}}}, aa)
